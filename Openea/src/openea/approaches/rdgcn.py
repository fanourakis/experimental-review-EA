...
class RDGCN(BasicModel):
    ...
    def training(self):
        ...
        for i in range(1, self.args.max_epoch + 1):
            ...
            # ********************no early stop********************************************
            # Uncomment for reporting metric every 1 epoch
            # flag = self.valid_(self.args.stop_metric, t)

            if i >= self.args.start_valid and i % self.args.eval_freq == 0:

                # Comment for reporting metric every 1 epoch and uncomment the previous command
                flag = self.valid_(self.args.stop_metric, t)
    ...
    def test(self, save=True):
        ...
        rest_12, _, _, TTA_flag = test(embeds1, embeds2, None, self.args.top_k, self.args.test_threads_num,
    ...
    def valid_(self, stop_metric, t):
        ...
        hits1_12, mrr_12, TTA_flag = valid(embeds1, embeds2, None, self.args.top_k, self.args.test_threads_num,
